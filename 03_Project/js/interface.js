document.addEventListener('DOMContentLoaded', () => {
    ...
    const imagePaths = [
        'img/box/Interface1.png',
        'img/box/Interface2.png',
        'img/box/Interface3.png',
        'img/box/Interface4.png',
        'img/box/Interface5.png',
        'img/box/Interface6.png',
        'img/box/Interface7.png',
        'img/box/Interface8.png',
        'img/box/Interface9.png',
        'img/box/Interface10.png'
