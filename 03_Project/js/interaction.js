document.addEventListener('DOMContentLoaded', () => {
    ...
    const imagePaths = [
        'img/box/Interaction1.png',
        'img/box/Interaction2.png',
        'img/box/Interaction3.png',
        'img/box/Interaction4.png',
        'img/box/Interaction5.png',
        'img/box/Interaction6.png',
        'img/box/Interaction7.png',
        'img/box/Interaction8.png',
        'img/box/Interaction9.png',
        'img/box/Interaction10.png'
